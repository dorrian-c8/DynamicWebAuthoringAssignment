    ...
    "houses": [
        {
            ...
            "Description": "Immaculately presented spacious detached home, situated in Belfast, it enjoys a good position within a popular and quiet cul-de-sac with an open outlook to the front with an enclosed private garden. The property is convenient location to the local shops and Belfast primary school is within walking distance, making it desirable for those with young families. The interior of the home has been finished to a very high ‘Show home’ specification and provides bright, spacious accommodation. Accommodation comprises of; Hallway, Reception Room, Kitchen/Dining Room, Three Bedrooms, and Bathroom. There is a tarmac driveway with off street parking for several vehicles. Early Viewing is highly recommended.",
        ...
        },
        {
            ...
            "Description": "A convential and welcoming apartment complex, situated in Stockmans lane, Belfast, it is in a great location, close to Boucher road shopping, Lisburn road's amazing food & drink locations & right next to the motorway for quick access to Belfast City Center or Lisburn.",
        ...
        },
        {
            ...
            "Description": "This is a 2 Bed Mid-Terrace House in the popular Pine Cross area of Seymour Hill, Dunmurry close to all local amenities, shops, schools and good transport links. The Ground Floor has a separate Lounge, Dining Room and Kitchen. First Floor has 2 Bedrooms and Bathroom.",
